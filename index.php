...
<table width="102%"  border="0" cellpadding="1" bgcolor="#66CCCC" align="center">
  <tr valign="top">
    ...
    <td bgcolor="#66CCCC">
      ...
      <tr><td align="center"><a href="index.php"><br>Home</a></td></tr>
    ...
    <tr><td align="center"><div onclick="loadHTML('futures.php','RequestDetails')" style="cursor:pointer"><h2></h2></div></td></tr>
    </table>
	</td>
